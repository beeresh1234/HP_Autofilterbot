...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8005648537').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002688422433').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002647662043') # give your force subscribe channel id here else leave it blank
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Howtoopenlink271/41') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
