...
‣ ᴏᴡɴᴇʀ :  <a href='https://t.me/HP_Raj_Bot'>𝐇𝐏_𝐑𝐚𝐣</a> 
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=HP_Raj-{}
...
<b>ɴᴏᴛᴇ:</b>
 <b>✯ Maintained by : <a href={}>𝐇𝐏_𝐑𝐚𝐣</a></b>
...
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code></b>"""
    ...
    LOG_TEXT_G = """#HP_Bot_In_NewGroup
Gʀᴏᴜᴘ = {}(<code>{}</code>)
Tᴏᴛᴀʟ Mᴇᴍʙᴇʀs = <code>{}</code>
Aᴅᴅᴇᴅ Bʏ - {}"""

    LOG_TEXT_P = """#NewUser_To_HP
ID - <code>{}</code>
Nᴀᴍᴇ - {}"""
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """ɪ ᴛʜɪɴᴋ ꜱᴩᴇʟʟɪɴɢ ᴍɪꜱᴛᴀᴋᴇ  ɪɴ ʏᴏᴜʀ ʀᴇqᴜᴇꜱᴛ {} ❗\n\nʙᴜᴛ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ. 😊 ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ʙᴇʟᴏᴡ?"""
...
ᴇxᴀᴍᴘʟᴇ : Master or Master 2021 or Master Kan

ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 👇

ᴇxᴀᴍᴘʟᴇ : Money Heist S01 or Money Heist S01E04 or Lucifer S03E24
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ...\n\nꜱᴏ ᴩʟᴇᴀꜱᴇ ʀᴇqᴜᴇꜱᴛ ᴛᴏ ᴀᴅᴍɪɴ @HP_Raj_Bot"""

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Mᴏᴠɪᴇ Iɴ Dᴀᴛᴀʙᴀsᴇ..."""

    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ {} Gʀᴏᴜᴘ ❤️.ʜᴏᴡ ᴀʀᴇ ʏᴏᴜ 😊</,b>"""
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v2.7.1 [ Sᴛᴀʙʟᴇ ]</code></b>"""
    ...
    LOGO = """ʜᴩ_ʀᴀᴊ ɪꜱ ʟɪᴠᴇ. ꜱᴛᴀʀᴛ ʏᴏᴜʀ ʙᴏᴛ ɴᴏᴡ"""
